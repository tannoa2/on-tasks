...
function taskGraphFactory(
    ...
    var timer1
    TaskGraph.prototype.persist3 = function() {
        var self = this;
        var timer1 ;
        var graphDone = false
        var taskDone = false

        var taskdependencies = this.createTaskDependencyItems().map(function(item){
            return store.persistTaskDependencies1(item, self.instanceId)
        })
        taskdependenciesArr.push(taskdependencies)
        ...
        return new Promise(function(resolve, reject){
            ...
            if((timer1 === undefined || timer1._called === true)){
                // if((taskdependenciesArr.length > 0)&&(timer1 === undefined || timer1._called === true)){
